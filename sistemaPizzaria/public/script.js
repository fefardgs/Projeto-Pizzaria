//Aqui basicamentente fica o codigo javascript do frontend, ou seja, o codigo que roda no navegador do usuario. 
// Ele é responsavel por fazer as requisições para a API, manipular o DOM, e controlar a interface do usuario.
//  Ele é separado do backend para manter a organização do projeto e permitir que o frontend e o backend sejam desenvolvidos de forma independente.
//  O frontend pode ser desenvolvido usando qualquer framework ou biblioteca de JavaScript, ou mesmo usando o JavaScript puro, como é o caso aqui. 
// O importante é que ele consuma a API fornecoida pelo backend para realizar as operações necessarias, como fazer login, listar pizzas, criar pedidos, etc.
