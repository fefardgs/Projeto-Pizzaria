//basicamente nesse index fica as rotas da API, ou seja as rotas são os caminhos que o frontend vai usar para acessar os dados do backend, 
// como por exemplo /api/pizzas para listar as pizzas, ou /api/pedidos par lisatr pedidos, etc.
