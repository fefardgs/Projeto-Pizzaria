...
├── pizzaria.db           # Arquivo do banco de dados SQLite
├── README.md             # Documentação do projeto
└── seed.js               # Script para preencher o banco de dados inicialmente.